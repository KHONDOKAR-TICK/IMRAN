...
\033[1;95m_______ad88888888888888888888888a, 
...
\033[1;91m:.KHONDOKAR- IMRAN M̳A̳S̳T̳E̳R̳
\033[1;91m:•◈•𝑰𝑴𝑹𝑨𝑵 𝑲𝒉𝒐𝒏𝒅𝒐𝒌𝒂𝒓
\033[1;91m:•◈•H̴̺̫͉̾͠A̴͔͓͋͒͒C̸̟̻̦̐͝͠K̵̡̼̘̈́̚͠E̴͎̠̒̔̐R̸̙̪̘͊̕͝ ｴᙏᏒ𝓐Ɲ Ⲕԋσɳԃσƙαɾ
\033[1;91m:•◈•нⷩAͣCͨᴋⷦ ᴛⷮнⷩEͤ нⷩAͣCͨᴋⷦEͤRͬ
\033[1;91m:•◈•IMRAN 𝗛𝗔𝗖𝗞𝗘𝗥
...
jalan("\033[1;91m------------------------------------------------")                                     
jalan("\033[1;93m --Tool Update 100%   Welcome to B4 -IMRAN----")
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:KHONDOKAR-TICK
	print logo
...
def pilih_super():
	...
	print "  \033[1;91m«---•◈•---Developed By Khondokar--•◈•---»" #Dev:KHONDOKAR-TICK
